      ...
      child: Scaffold(
        body: SingleChildScrollView(
          child: Column(
            children: [
             //Custom App BAr
              const CustomAppBar(tittle:  "Onyeka_Embedded",),
              SizedBox(
                height: 0.05 * h,
              ),
                    ...
                    child: Row(
                      ...
                      children: [
                        InkWell(
                          ...
                          child: const CustomButton(text: "About",)
                          ),
                          InkWell(
                          onTap: (){
                          ...
                          child: const CustomButton(text: "Skills",)
                          ),
                      ],
                    ),
                  ),
              ...
              Padding(
                ...
                child: Row(
                  ...
                  GestureDetector(
                     onTap: () async{
                      if (!await launchUrl(Uri.parse("https://www.youtube.com/channel/UCFCldU2b88QR46FmeDGUvcA/"), mode: LaunchMode.externalApplication)){
                      throw 'Could not launch ${"https://www.youtube.com/channel/UCFCldU2b88QR46FmeDGUvcA/"}';
                      }
                       },
                    child: const Socials(image:"assets/images/youtube.png")
                    ),
                   GestureDetector(
                     onTap: () async{
                      if (!await launchUrl(Uri.parse("https://www.linkedin.com/mwlite/in/onyeka-ekwunife-9b2527176"), mode: LaunchMode.externalApplication)){
                      throw 'Could not launch ${"https://www.linkedin.com/mwlite/in/onyeka-ekwunife-9b2527176"}';
                      }
                       },
                     child: const Socials(image:"assets/images/linkdln.jpeg")),
                    GestureDetector(
                     onTap: () async{
                      if (!await launchUrl(Uri.parse("https://www.github.com/onyeka-embedded"), mode: LaunchMode.externalApplication)){
                      throw 'Could not launch ${"https://www.github.com/onyeka-embedded"}';
                      }
                       },
                     child: const Socials(image:"assets/images/github.png")),
